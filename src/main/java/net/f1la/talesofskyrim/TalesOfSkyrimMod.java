package net.f1la.talesofskyrim;

import com.mojang.logging.LogUtils;
import net.f1la.talesofskyrim.block.ModBlocks;
import net.f1la.talesofskyrim.item.ModCreativeModeTabs;
import net.f1la.talesofskyrim.item.ModItemProperties;
